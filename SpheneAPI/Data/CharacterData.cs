...
public class CharacterData
{
    public CharacterData()
    {
        ...
        RestHash = new(() => ComputeHash(new RestHashData(CustomizePlusData, HeelsData, HonorificData, MoodlesData, PetNamesData, HasBypassEmote)));
    }
...
#pragma warning restore SYSLIB0021 // Type or member is obsolete
    ...
    private sealed record RestHashData(Dictionary<ObjectKind, string> CustomizePlusData, string HeelsData, string HonorificData, string MoodlesData, string PetNamesData, bool HasBypassEmote);
}
